...
class TestBaseView(TestCase):
    ...
    def test_view_url_accessible_by_name_template(self):
        resp = self.client.get(reverse('base'))
        self.assertEqual(resp.status_code, 200)
...
class TestBookView(TestCase):
    ...
    def setUpTestData(cls):
        User.objects.create(id=2, full_name='Иванов Иван', middle_name='Иванович', birth_day=datetime.date(
    ...
    def test_view_url_exists_at_desired_location_template(self):
        resp = self.client.get('/book/2/')
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, 'base.html')
...
class TestEditView(TestCase):
    ...
    def setUpTestData(cls):
        user = User.objects.create(id=2, full_name='Иванов Иван', middle_name='Иванович', birth_day=datetime.date(
            1997, 5, 2), phone='+375(29)508-80-02')
        Book.objects.create(id=2, reader=user, book_name='Чистый код',
